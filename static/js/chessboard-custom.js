...
;(function () {
  ...
  var START_FEN = 'fncqkbnr/ppppzppp/8/8/8/8/PPPPZPPP/FNCQKBNR'
  ...
  function validPieceCode (code) {
    return isString(code) && code.search(/^[bw][KQRNBPFZC]$/) !== -1
  }
  ...
  function validFen (fen) {
    ...
    for (var i = 0; i < 8; i++) {
      if (chunks[i].length !== 8 ||
          chunks[i].search(/[^kqrnbpfzcKQRNBPFZC1]/) !== -1) {
        return false
      }
    }
